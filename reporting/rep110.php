...
function print_deliveries()
{
	...
	$cols = array(4, 35, 90, 360,465,530); // Adjust the values to define the right boundaries of your 4 columns

$aligns = array('left', 'left', 'left', 'center','center'); // Adjust the alignment values for each of your 4 columns
