...
function print_credits()
{
	...
	$cols = array(4, 40, 100, 300, 350, 400, 445, 500);

	// $headers in doctext.inc
	$aligns = array('left',	'left',	'left', 'center', 'center', 'center', 'right', 'center');
...
$rep->aligns[5] = 'right'; // Price
$rep->aligns[6] = 'right'; // Discount
$rep->aligns[7] = 'right'; // Net Amount
...
$rep->TextCol(3, 4, $DisplayQty, -2);   // Right-aligned
$rep->TextCol(4, 5, $myrow2['units'], -2);
$rep->TextCol(5, 6, $DisplayPrice, -2); // Right-aligned
$rep->TextCol(6, 7, $DisplayDiscount, -2); // Right-aligned
$rep->TextCol(7, 8, $DisplayNet, -2);   // Right-aligned
		...
		$words = price_in_words2($myrow['Total'], ST_CUSTCREDIT);
		if ($words != "") {
			$rep->NewLine(1);
		...
		$rep->aligns[7] = 'right'; // Ensure right alignment for total amounts
		...
		$rep->Font('bold');
		$rep->TextCol(4, 7, _("TOTAL CREDIT"), -2);
